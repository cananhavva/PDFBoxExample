...
public class PDFboxCreation {
	...
	private static final String PDF_FILE = "C:\\Users\\canan\\eclipse-workspace\\PDFBoxExample\\src\\com\\javaCourse\\PDFBoxExample.pdf";
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.err.println("PDF işlenirken hata oluştu: " + e.getMessage());
		}
	...
	private static void createPDFWithImage() throws IOException {
		...
		try (PDDocument pdf = new PDDocument()) {
			...
			String imageFileName = "C:\\Users\\canan\\Pictures\\Saved Pictures\\20503317.jpg";
